...
namespace Cereal64.Microcodes.F3DZEX
{
    ...
    public static class F3DZEXReader
    {
        ...
        private static F3DZEX_G_SetTile _lastSetTile;
        private static F3DZEX_G_SetTImg _lastSetTImg;
        private static F3DZEX_G_SetTileSize _lastSetTileSize;
        private static F3DZEX_G_LoadBlock _lastLoadBlock;
        private static F3DZEX_G_LoadTLut _lastLoadTLut;
    ...
    //    }
    //}
    //public class CommandComparer : IEqualityComparer<F3DZEXCommand>
    //{
    //    public bool Equals(F3DZEXCommand command1, F3DZEXCommand command2)
    //    {
    //        return command1.FileOffset == command2.FileOffset;
    //    }
    //    public int GetHashCode(F3DZEXCommand command)
    //    {
