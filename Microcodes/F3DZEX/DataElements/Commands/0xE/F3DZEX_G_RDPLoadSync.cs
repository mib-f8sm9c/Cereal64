...
{
    public class F3DZEX_G_RDPLoadSync : F3DZEXCommand
    {
        ...
        { get { return F3DZEXCommandID.F3DZEX_G_RDPLOADSYNC; } }
        ...
        private const string _commandDesc = "Synchronize with rendering to safely load texture";
