...
{
    public class F3DZEX_G_Special_2 : N64DataElement, IF3DZEXCommand
    {
        ...
        { get { return F3DZEXCommandID.F3DZEX_G_SPECIAL_2; } }
        
        [CategoryAttribute("F3DZEX Settings"),
        ReadOnlyAttribute(true),
        DescriptionAttribute(_commandDesc)]
        public string CommandName
        { get { return "G_SPECIAL_2"; } }
        ...
        public F3DZEX_G_Special_2(int index, byte[] rawBytes)
            : base (index, rawBytes)
        {
        }
