...
{
    public class F3DEX_G_ClearGeometryMode : F3DEXCommand
    {
        ...
        { get { return F3DEXCommandID.F3DEX_G_CLEARGEOMETRYMODE; } }
        
        [CategoryAttribute("F3DEX Settings"),
        ReadOnlyAttribute(true),
        DescriptionAttribute(_commandDesc)]
        public override string CommandName
        { get { return "G_CLEARGEOMETRYMODE"; } }
        
        [BrowsableAttribute(false)]
        public override string CommandDesc //Copied from CloudModding
        { get { return _commandDesc; } }
        private const string _commandDesc = "Clears RSP Geometry Mode";
        ...
        public F3DEX_G_ClearGeometryMode(int index, byte[] rawBytes)
            : base (index, rawBytes)
        {
        }
