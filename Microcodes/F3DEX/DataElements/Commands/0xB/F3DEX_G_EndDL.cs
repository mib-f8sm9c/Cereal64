...
{
    public class F3DEX_G_EndDL : F3DEXCommand
    {
        ...
        { get { return F3DEXCommandID.F3DEX_G_ENDDL; } }
        ...
        private const string _commandDesc = "End current display list";
        ...
        public F3DEX_G_EndDL(int index, byte[] rawBytes)
            : base (index, rawBytes)
        {
        }
