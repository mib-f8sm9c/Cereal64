...
{
    public class F3DEX_G_Mtx : F3DEXCommand
    {
        ...
        { get { return F3DEXCommandID.F3DEX_G_MTX; } }
        ...
        public F3DEX_G_Mtx_Params Params { get { return _params; } set { _params = value; Updated(); } }
        private F3DEX_G_Mtx_Params _params;
        ...
        public F3DEX_G_Mtx(int index, byte[] rawBytes)
            : base (index, rawBytes)
        {
        }
        ...
        public override byte[] RawData
        {
            ...
            set
            {
                ...
                Params = new F3DEX_G_Mtx_Params(ByteHelper.ReadByte(value, 3));
    ...
    public struct F3DEX_G_Mtx_Params
    {
        ...
        public F3DEX_G_Mtx_Params(byte flags)
        {
