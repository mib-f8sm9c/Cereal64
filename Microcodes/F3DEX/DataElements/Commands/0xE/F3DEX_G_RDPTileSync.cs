...
{
    public class F3DEX_G_RDPTileSync : F3DEXCommand
    {
        ...
        { get { return F3DEXCommandID.F3DEX_G_RDPTILESYNC; } }
        ...
        private const string _commandDesc = "Synchronize with rendering to safely update tile descriptor attributes";
        ...
        public F3DEX_G_RDPTileSync(int index, byte[] rawBytes)
            : base (index, rawBytes)
        {
        }
